      ...
      >
        <div className="relative group">
          <div className="r relative">
            <img src={item.img ?item.img : ''} alt="" className="w-full h-60" />
            {item.pricerival ? (
        ...
        <div className="pt-4 pb-3 px-4">
          ...
          <span className="text-primary text-xl mr-2">{`LE ${item.price? item.price.toLocaleString() :''}.00`}</span>
          <span className="line-through text-sm text-gray-400">
            {item.pricerival ? `LE ${item.pricerival.toLocaleString()}.00` : ""}
          </span>
  ...
  return (
    <div className="container pt-16 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {loading ? (
          <div className='container flex justify-center py-4 w-screen'>
